...
export const mockVideos = [
  ...
  },
  {
    ...
    username: 'nature_explorer',
    avatar: 'https://i.pravatar.cc/150?img=1',
    description: 'Arjuna approaches and circumambulates the bow',
    moreInfo: `What if a bow could change destiny? In a grand assembly, Arjuna stood before a mighty bow. He circled it with reverence, then bowed his head. In a flash, he strung the bow, grasped five arrows. With one swift shot, he pierced the target. The crowd erupted in shock and awe. Flowers rained from the heavens. Musicians played jubilant tunes. Drupada, the king, beamed with pride. Arjuna's victory was a testament to skill and destiny. In that moment, the world saw the power of focus and faith. Want more Mahabharata stories? Follow for daily wisdom.`,
    likes: 125400,
    comments: 3421,
    shares: 892,
    date: 'Nov 30, 2025'
